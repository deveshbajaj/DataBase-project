...
form_class, QMainWindow = uic.loadUiType("DATA.ui")
...
class ddisplay(QMainWindow, form_class):
    ...
    def customer(self):#create process that will display all telementry data
        Popen([executable, 'DATA_CUSTMER.py'], creationflags=CREATE_NEW_CONSOLE)
    def product_detail(self):
        Popen([executable, 'DATA_PRODUCT DETAIL.py'], creationflags=CREATE_NEW_CONSOLE) 
    def employee(self):
        Popen([executable, 'DATA_EMPLOYEE.py'], creationflags=CREATE_NEW_CONSOLE) 
